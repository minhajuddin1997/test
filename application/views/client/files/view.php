<div class="content-wrapper" style="min-height: 1071.31px;">
    ...
    <section class="content-header">
      <div class="container-fluid">
        ...
        <a class="btn btn-info" href="<?php echo base_url('/client/filemanager/add'); ?>">Start Uploading</a>
        <hr style="border-top: 1px solid #504444;opacity:0.1;" >
      </div><!-- /.container-fluid -->
    </section>
            ...
            <div class="row">
              <div class="col-5 col-sm-3">
                <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
                  <a class="nav-link active" id="vert-tabs-home-tab" data-toggle="pill" href="#vert-tabs-home" role="tab" aria-controls="vert-tabs-home" aria-selected="true">My Files</a>
