...
<div id="accordion" id='payment'>
  ...
  <div class="card">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
      <div class="card-body">
                  <form role="form" action="<?php echo base_url(); ?>client/market/pay/<?php echo $id; ?>" method="post" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="pk_test_bbpGR0QxhGaiNwq94HzFyQbT" id="payment-form" >
