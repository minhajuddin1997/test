...
<!--         <p>- OR -</p>
 -->     <!--    <a href="#" class="btn btn-block btn-primary">
      ...
      <p class="mb-1">
        <a href="<?php echo base_url(); ?>front/forgot_password">I forgot my password</a>
      </p>
      <p class="mb-0">
        <a href="<?php echo base_url(); ?>front/register" class="text-center">Register a new membership</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
