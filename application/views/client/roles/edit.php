                        ...
                        <div class="card">
                           ...
                           <!--          <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" name="role_permission[]" <?php echo (in_array('createDevelopmentStatus',$permission) ? 'checked' : '') ?> id="role_permission"
                                                   value="createDevelopmentStatus"></td>
                                        <td><input type="checkbox" name="role_permission[]" <?php echo (in_array('updateDevelopmentStatus',$permission) ? 'checked' : '') ?> id="role_permission"
                                                   value="updateDevelopmentStatus"></td>
                                        <td><input type="checkbox" name="role_permission[]" <?php echo (in_array('viewDevelopmentStatus',$permission) ? 'checked' : '') ?> id="role_permission"
                                                   value="viewDevelopmentStatus"></td>
                                        <td><input type="checkbox" name="role_permission[]" <?php echo (in_array('deleteDevelopmentStatus',$permission) ? 'checked' : '') ?> id="role_permission"
                                    ...
                                    <tr>
                                        ...
                                        <td>-</td>
                                        <td><input type="checkbox" name="role_permission[]" <?php echo (in_array('updateSetting',$permission) ? 'checked' : '') ?> id="role_permission"
