...
<body>
<table background="" bgcolor="#E6B86A" width="100%" style="padding:20px 0 20px 0; border:4px solid #000000;" cellspacing="0" border="0" align="center" cellpadding="0">
  <tbody>
    <tr>
      <td><table width="500" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="border-radius: 5px; font-family: Arial, Helvetica, sans-serif">
          <tbody>
            <tr>
              <td style="padding-top:20px; text-align:center;"><img src="https://cdn.shortpixel.ai/spai/q_lossy+ret_img/https://www.dynistybranding.com/wp-content/uploads/2020/04/cropped-cropped-logo.png"></td>
            </tr>
            <tr>
